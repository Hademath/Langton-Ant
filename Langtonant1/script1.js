...
function startAnt () {
  const color = surface.getImageData(ant.y, ant.x, 1, 1) // the number 1, 1 shows the dirction the ant should move respect to the cardinal point
  const antColor = color.data[0]
  if (antColor > 100) {
